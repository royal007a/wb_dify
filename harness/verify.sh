...
detect_scopes() {
  ...
  while IFS= read -r path; do
    ...
    case "$path" in
      backend/hify-app/src/main/resources/db/migration/*|backend/hify-app/src/main/java/db/migration/*) add_scope migration ;;
    esac
    case "$path" in
    ...
    case "$path" in
      backend/hify-chat/src/main/java/com/hify/intent/*|backend/hify-chat/src/test/java/com/hify/intent/*|backend/hify-chat/src/test/resources/intent/*|backend/hify-chat/src/main/java/com/hify/runtime/context/*|backend/hify-chat/src/test/java/com/hify/runtime/context/*|backend/hify-chat/src/main/java/com/hify/memory/*|backend/hify-chat/src/test/java/com/hify/memory/*|backend/hify-chat/src/test/resources/recall/*|docs/evidence/intent-*|docs/evidence/recall-*) add_scope eval ;;
    esac
  done <"$changes_file"
