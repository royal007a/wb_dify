...
@Component
public class OpenAiCompatibleProtocolAdapter implements ProviderProtocolAdapter {
    ...
    public OpenAiCompatibleProtocolAdapter(ObjectMapper objectMapper, LlmHttpClient httpClient,
                                           CircuitBreakerService resilience,
                                           ProviderAuthConfigCodec authCodec,
    ...
    @Override public ProviderType type() { return ProviderType.OPENAI_COMPATIBLE; }
