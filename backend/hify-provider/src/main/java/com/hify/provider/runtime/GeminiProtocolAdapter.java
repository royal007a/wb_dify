...
import com.hify.runtime.GeminiModelClient;
import com.hify.runtime.ModelClient;
import org.springframework.stereotype.Component;

@Component
public class GeminiProtocolAdapter implements ProviderProtocolAdapter {
    ...
    public GeminiProtocolAdapter(ObjectMapper objectMapper, LlmHttpClient httpClient,
    ...
    @Override public ProviderType type() { return ProviderType.GEMINI; }

    @Override public ModelClient create(ProviderRuntimeConfig provider) {
        return new GeminiModelClient(provider, objectMapper, httpClient, resilience, authCodec, credentials);
    }
}
